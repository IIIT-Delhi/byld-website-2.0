...
export default function Navbar() {
	return (
		<div className="flex sticky bg-white z-50 top-0 flex-row items-center justify-between h-[96px] py-[27px] md:px-16 sm:px-10 px-2.5 ">
			<NavigationMenu>
				<NavigationMenuList>
					<NavigationMenuItem>
						<NavigationMenuTrigger>
							...
							<ul className="flex p-1 items-center justify-center flex-col space-y-3">
								...
								>
									<NavigationMenuLink asChild>
										<a
											href="/members"
											className="text-sm p-2 font-spaceGrotesk"
										>
											Members
										</a>
									</NavigationMenuLink>
